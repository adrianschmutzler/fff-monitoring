...
CONFIG = {
	...
	"router_stat_days": 90,				# Router stats are collected for X days
	"router_stat_netif": 90,			# Router stats for netifs are collected for X days
	"router_stat_gw": 30,				# Router stats for gw are collected for X days
